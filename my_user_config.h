...
// -- Project -------------------------------------
#define PROJECT                "richelly"          // PROJECT is used as the default topic delimiter //baurichi
...
#define STA_SSID2              "TP-Link_383C"    // [Ssid2] Optional alternate AP Wifi SSID //baurichi
#define STA_PASS2              "77547873"                // [Password2] Optional alternate AP Wifi password
...
#define MQTT_HOST              "192.168.2.2"     // [MqttHost] //baurichi
...
#define MQTT_USER              "richard"         // [MqttUser] MQTT user  //baurichi
#define MQTT_PASS              "HomeRichi42"     // [MqttPassword] MQTT password  //baurichi
...
#define MQTT_TOPIC             "richelly/DVES_%06X"     // [Topic] (unique) MQTT device topic, set to 'PROJECT "_%06X"' for unique topic including device MAC address //baurichi
#define MQTT_GRPTOPIC          "shellys"         // [GroupTopic] MQTT Group topic  //baurichi
...
#define FRIENDLY_NAME          "Richis_Shelly"   // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa  //baurichi
...
// -- Location ------------------------------------
#define LATITUDE               49.89629051930776         // [Latitude] Your location to be used with sunrise and sunset  //baurichi
#define LONGITUDE              8.833671286334193          // [Longitude] Your location to be used with sunrise and sunset //baurichi
...
#define SWITCH_MODE            PUSHBUTTONHOLD    // [SwitchMode] TOGGLE, FOLLOW, FOLLOW_INV, PUSHBUTTON, PUSHBUTTON_INV, PUSHBUTTONHOLD, PUSHBUTTONHOLD_INV, PUSHBUTTON_TOGGLE (the wall switch state)  //baurichi
...
#define MY_LANGUAGE            de-DE           // German in Germany  //baurichi
